...
For more details on the various cost-saving measures made possible within the context of personal projects, see [this blog post](https://blog.chongya.ng/managed-kubernetes-on-a-hobbyist-budget.html) for more details.
